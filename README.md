...
read the instructions [https://github.com/MIKCPU/Maximuxbat-installer-Batocera/blob/main/README.md](https://github.com/MIKCPU/Maximuxbat-installer/blob/main/README.md)
```
ITA
```
